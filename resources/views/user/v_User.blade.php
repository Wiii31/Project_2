                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                            <div class="categories__item set-bg"
                                data-setbg="{{ asset('template2') }}/img/categories/category-2.jpg">
                                <div class="categories__text">
                                    <h4>Decorations</h4>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                            <div class="categories__item set-bg"
                                data-setbg="{{ asset('template2') }}/img/categories/category-3.jpg">
                                <div class="categories__text">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                            <div class="categories__item set-bg"
                                data-setbg="{{ asset('template2') }}/img/categories/category-4.jpg">
                                <div class="categories__text">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                            <div class="categories__item set-bg"
                                data-setbg="{{ asset('template2') }}/img/categories/category-5.jpg">
                                <div class="categories__text">
                                    <h4>Photography</h4>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-7">
                    <div class="footer__about">
                        ...
                        <p>We create unforgettable wedding moments with elegance and charm. Let us help you plan your dream
                            day.</p>
                        <div class="footer__payment">
                            <a href="#"><img src="{{ asset('template2') }}img/payment/payment-1.png"
                                    alt=""></a>
                            <a href="#"><img src="{{ asset('template2') }}img/payment/payment-2.png"
                                    alt=""></a>
                            <a href="#"><img src="{{ asset('template2') }}img/payment/payment-3.png"
                                    alt=""></a>
                            <a href="#"><img src="{{ asset('template2') }}img/payment/payment-4.png"
                                    alt=""></a>
                            <a href="#"><img src="{{ asset('template2') }}img/payment/payment-5.png"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Schedule Metting</a></li>
